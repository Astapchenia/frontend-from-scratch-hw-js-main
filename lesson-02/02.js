...
let dice1 = Math.floor(Math.random() * 6) + 1; // генерируем случайное число от 1 до 6 для первого дайса
let dice2 = Math.floor(Math.random() * 6) + 1; // генерируем случайное число от 1 до 6 для второго дайса
let isWinningDouble = (dice1 === dice2 && dice1 > 3); // проверяем, является ли выпавший дубль выигрышным
